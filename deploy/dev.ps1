...
Write-Host "`n=== Diomika dev local ===" -ForegroundColor Cyan
Write-Host "API produção: https://api.diomika.com"
Write-Host "Loja:         http://127.0.0.1:5173"
Write-Host "Backoffice:   http://127.0.0.1:5174`n"
...
Write-Host "Para parar: fecha as janelas PowerShell.`n"
